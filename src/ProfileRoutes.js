...
import ThisWeekTest from './views/ThisWeekTest';
    ...
    return (
      <>
        ...
        <Switch>
          ...
          <Route path={`${match.url}/this-week/:view?`} exact render={route => <ThisWeek {...route} />} />
          <Route path={`${match.url}/this-week-test/:view?`} exact render={route => <ThisWeekTest {...route} />} />
